        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 py-12 md:py-16">
            ...
            <div className="mb-12">
                ...
                <p className="text-sm text-neutral-500 mt-2">
                    {user?.first_name}, here's what's happening with your shop.
                </p>
                {seller?.verification_status === 'pending' && (
                    <div className="mt-4 inline-flex items-center gap-2 bg-neutral-50 border border-neutral-200 px-4 py-2">
                        <Icons.Clock />
